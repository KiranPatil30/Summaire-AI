...
const steps: Step[] = [
  ...
  },
  {
    ...
    label: "AI Analysis",
    description:
      "Our advanced AI processes and analyzes your document instanly",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary ",
    description: "Recive a clear , consise summary of your document",
  },
];
            ...
            >
              ...
              {idx < steps.length - 1 && (
                <MotionDiv
                  ...
                  className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-0.5 z-10"
                >
                  <MoveRight
                    size={32}
                    strokeWidth={1}
