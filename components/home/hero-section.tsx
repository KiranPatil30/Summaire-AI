...
import { cotainerVariants, itemVariants } from "@/utils/constants";
...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <MotionH2
        variants={itemVariants}
        className="text-lg mt-6 sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600"
      >
        Get a beutiful summary reel of the document in seconds.
      </MotionH2>
